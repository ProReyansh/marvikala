    ...
    <footer className="footer">
      <div className="footer-grid">
        ...
        <div className="footer-brand">
          <img src="/marvikala-logo.png" alt="Marvikala" className="footer-logo-img" />
        ...
        <div className="footer-col">
          ...
          <ul>
            ...
            <li><button onClick={() => goSection('new-arrivals')} className="footer-link-btn">New Arrivals</button></li>
          </ul>
        </div>
      ...
      {/* Stay Connected — full-width centered strip */}
      <div className="footer-stay-connected">
        <h4 className="footer-stay-heading">Stay Connected</h4>
        <div className="footer-connect-links">
          <a href="https://wa.me/918767797815" target="_blank" rel="noreferrer" className="footer-connect-row" aria-label="WhatsApp">
            <div className="footer-connect-text">
              <span className="footer-connect-label">WhatsApp</span>
              <span className="footer-connect-value">+91 87677 97815</span>
            </div>
