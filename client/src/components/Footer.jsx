    ...
    <footer className="footer">
      <div className="footer-grid">
        ...
        <div className="footer-brand">
          ...
          <p className="footer-tagline">Handmade with love, just for you 🧶<br />Small batch crochet from Mumbai.</p>
        ...
        <div className="footer-col">
          ...
          <ul>
            ...
            <li><a href="#products">Bookmarks</a></li>
            <li><a href="#products">Laddu Gopal</a></li>
