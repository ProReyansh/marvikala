      ...
      <div className="footer-grid">
        ...
        <div className="footer-col">
          ...
          <ul>
            ...
            <li><button onClick={() => goTo('/collections')} className="footer-link-btn">All Collections</button></li>
        ...
        <div className="footer-col">
          ...
          <div className="footer-contact-item footer-contact-item--row">
            <div className="footer-contact-text">
              <span>+91 97692 38160</span>
            </div>
            <a href="https://wa.me/919769238160" target="_blank" rel="noreferrer" className="footer-social-link footer-social-link--inline" aria-label="WhatsApp">
          ...
          <div className="footer-contact-item footer-contact-item--row" style={{ marginTop: 12 }}>
            <div className="footer-contact-text">
              <span>@marvikala</span>
            </div>
            <a href="https://instagram.com/marvikala" target="_blank" rel="noreferrer" className="footer-social-link footer-social-link--inline" aria-label="Instagram">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><circle cx="12" cy="12" r="3.5"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg>
            </a>
          </div>
        </div>
