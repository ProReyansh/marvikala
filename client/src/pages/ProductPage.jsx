      ...
      <div className={`product-page ${pageAnim}${exiting ? ' pp-exit' : ''}`}>
        ...
        <div className="product-page-layout">
          ...
          <div className="product-page-info">
            ...
            {isBestseller && (
              <div className="pp-bs-banner"><span>✦</span> Most Loved · Bestselling Product</div>
            )}
            ...
            {product.inStock ? (
              <>
                ...
                <p className="product-page-cta">Or order directly via</p>
                <div className="product-page-action-row">
                  <a href={`https://wa.me/919769238160?text=Hi! I'm interested in: ${encodeURIComponent(product.name)}`}
                    className="product-page-contact-btn pp-wa" target="_blank" rel="noreferrer">
                  ...
                  <a href="https://instagram.com/marvikala" className="product-page-contact-btn pp-ig" target="_blank" rel="noreferrer">
              ...
              <div className="product-page-oos-msg">
                ...
                <a href="https://instagram.com/marvikala" className="product-page-contact-btn pp-ig" target="_blank" rel="noreferrer"
                  ...
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
                    <rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><circle cx="12" cy="12" r="3.5"/>
                    <circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/>
                  </svg>
